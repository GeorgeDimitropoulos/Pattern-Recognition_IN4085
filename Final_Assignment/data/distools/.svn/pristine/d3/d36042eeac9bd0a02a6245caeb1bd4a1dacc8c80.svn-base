...
%
% DESCRIPTION
% Linear mapping W onto an M-dimensional Pseudo-Euclidean (PE) subspace from a 
% symmetric, square kernel matrix D such that the similarities are preserved.
...
%
% A trained mapping can be reduced further by:   W = KEM(W,ALF)
% The signature of the obtained PE space can be found by PE_SIG(W)
% The spectrum of 
%
% SEE ALSO
% MAPPINGS, DATASETS, PE_EM, AUGPSEM, PCAM, PE_PCA, PE_SPEC, GETSIG, SETSIG
%
% LITERATURE
...
% This routine is adapted from PE_EM by R.P.W. Duin. 

function [W,sig,L,Q] = kem(d,alf,pzero,prec)
