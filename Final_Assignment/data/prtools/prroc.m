...
%
% See SHIFTOP for computing an appropriate shift of the operating point of
% a trained classifier, or for combining this computation with training.
%
% EXAMPLES
...
% DATASETS, MAPPINGS, PLOTE, REJECT, SHIFTOP, TESTC, GETCLASSI
